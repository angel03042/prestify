  ...
  <section class="space-y-10 p-2">
    <div>
      ...
      <p class="text-zinc-400 mt-1">
        Aquí tienes un resumen de tus prestamos hoy
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
      ...
      <div class="group border border-zinc-700/50 rounded-2xl p-6 hover:border-emerald-500/30 transition-all duration-300">
        ...
        <span v-if="cargando" class="block h-8 w-24 animate-pulse bg-zinc-700 rounded mt-1"></span>
        <h3 v-else class="text-4xl font-bold text-emerald-500 mt-1">{{ datos.totalClientes }}</h3>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
      ...
      <div class="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-violet-700 border border-white/10 rounded-2xl p-8 flex flex-col justify-between shadow-2xl">
        <div class="relative z-10">
          ...
          <p class="text-indigo-100 text-sm leading-relaxed max-w-[280px]">
            Visualiza reportes detallados de ganancias, clientes y pagos.
          </p>
        </div>
